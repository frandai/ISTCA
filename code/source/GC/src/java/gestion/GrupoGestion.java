...
public class GrupoGestion implements Serializable {
    ...
    private boolean noExistenResponsables = false;

    public boolean isNoExistenResponsables() {
        getResponsables();
        return noExistenResponsables;
    }

    public void setNoExistenResponsables(boolean noExistenResponsables) {
        this.noExistenResponsables = noExistenResponsables;
    }
    ...
    /**
     * Constructor de la clase: inicializa las variables de modo de alta, desde
     * matrícula
     *
     */
    public GrupoGestion() {
    ...
    /**
     * Busca el Grupo Seleccionado. Inicializa las variables. Si es Nuevo Grupo,
     * se crea un objeto Grupo con variables por defecto.
     *
     * @return
     */
    ...
    /**
     * Los responsables a elegir serán las Personas (y teléfonos) asociados al
     * Proveedor Principal
     *
     * @return
     */
     ...
     *
     * -La suma de las Horas de Tutoría de los Tutores del Grupo ha de coincidir
     * con las Horas del Curso. -Debe de asociar una acción formativa al Grupo.
     * -Debe de asociar responsable al Grupo. -Debe de asociar un Proveedor al
     * Grupo que gestione la Acción Formativa seleccionada. -El grupo debe de
     * iniciarse en un día de la semana seleccionado para el grupo. -Se necesita
    ...
    /**
     * Recalcula a Fecha de Fin en base a las horas de tutoria y las horas del
     * curos
     *
     * @param actionEvent
     */
    ...
    /**
     * Devuelve si una fecha seleccionada es o no esdía de ausencia para el
     * grupo
     *
     * @param f
     * @return
    ...
    /**
     * Genera los horarios auxiliares para la creaciñon de horarios en base de
     * datos
     *
     * @return
     *
